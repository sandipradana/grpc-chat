...
func (c *chatServiceClient) Send(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
func (UnimplementedChatServiceServer) Send(context.Context, *Message) (*Message, error) {
